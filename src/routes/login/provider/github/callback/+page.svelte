<script lang="ts">
	...
	async function create() {
		loading = true;
		const createres = await fetch('/api/accounts/create/provider/github?login=true', {
			method: 'POST',
			headers: {
				...
				<Card.Root class="mx-4 w-full max-w-156 transition-[width] sm:w-[70%]">
					<Card.Header class="flex flex-col items-center gap-2">
						...
						<Card.Description class="text-center text-sm text-muted-foreground">
							Choose a username to create your account linked with your GitHub account.
						</Card.Description>
			...
			<div class="flex h-full w-full items-center justify-center" transition:slide>
				<Card.Root class="mx-4 w-full max-w-156 transition-[width] sm:w-[70%]">
					<Card.Header class="flex flex-col items-center gap-2">
						...
						<Card.Description class="text-center text-sm text-muted-foreground">
							No account is linked to this GitHub account. Would you like to create one?
						</Card.Description>
		...
		<div class="flex h-full w-full items-center justify-center" transition:slide>
			<Card.Root class="mx-4 w-full max-w-156 transition-[width] sm:w-[70%]">
				<Card.Header class="flex flex-col items-center gap-2">
					...
					<Card.Description class="text-center text-sm text-muted-foreground">
						Your GitHub account has been linked to this account.
					</Card.Description>
					<div class="my-2 flex items-center gap-4">
