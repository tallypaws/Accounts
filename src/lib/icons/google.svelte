<script lang="ts">
	...
	const iconNode: IconProps['iconNode'] = [];
	/**
	 * @component @name Discord
	 *
	 * @see https://lucide.dev/guide/packages/lucide-svelte
	 *
	 * @param {Object} props
...
<Icon name="google" {...props} {iconNode} color="none" viewBox="0 0 268.1522 273.8827">
